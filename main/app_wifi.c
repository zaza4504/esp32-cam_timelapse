...
static void event_handler_ap(void* arg, esp_event_base_t event_base,
                                int32_t event_id, void* event_data)
{
    if (event_base == IP_EVENT && event_id == WIFI_EVENT_AP_STACONNECTED) {
...
bool wifi_init_sta(void)
{
    ...
    esp_netif_t * wifi_sta_ins = esp_netif_create_default_wifi_sta();
    ...
    esp_wifi_stop();
    esp_netif_destroy_default_wifi(wifi_sta_ins);
    return false;
}
